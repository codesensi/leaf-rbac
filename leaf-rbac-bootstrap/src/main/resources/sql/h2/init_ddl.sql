...
(
    ...
    `duration_ms` bigint NULL DEFAULT NULL COMMENT 'c',
    `params`      text NULL DEFAULT NULL COMMENT '请求参数',
...
(
    ...
    `del_flag`    tinyint(1)    NULL DEFAULT 0 COMMENT '逻辑删除标识:0-未删除,1-已删除',
    PRIMARY KEY (`id`),
    INDEX         `idx_dd_type` (`type` ASC),
    INDEX         `idx_dd_code` (`code` ASC)
)ENGINE = InnoDB
  CHARACTER SET = utf8mb4
