...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public List<String> listPermsCodeByUserId(Long userId) {
        ...
        // 获取角色拥有的权限码列表
        List<SysMenu> sysMenus = new QueryChain<>(sysMenuMapper)
                ...
                .where(SYS_ROLE.STATUS.eq(0))
                .and(SYS_MENU.STATUS.eq(0))
                .and(SYS_ROLE.CODE.in(roleCodeList))
                .list();
        // 获取去重后的权限码
    ...
    public List<RouteDTO> getRoutesByUserId(Long userId) {
        ...
        List<SysMenu> menus = new QueryChain<>(sysMenuMapper)
                ...
                .where(SYS_ROLE.STATUS.eq(0))
                .and(SYS_MENU.STATUS.eq(0))
                .and(SYS_MENU.TYPE.ne(3))
                .and(SYS_ROLE.CODE.in(roles))
                .list();
